...
function setQuaternionFromProperEuler( q: Quaternion, a: number, b: number, c: number, order: EulerOrder ) {
...
function denormalize( value: number, array : number[]) {
...
function normalize( value: number, array : number[]) {
