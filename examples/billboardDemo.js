...
export class BillboardDemo extends Demo {
    name = 'Horizon, Vertical & Stretched Billboard';
    ...
    initScene() {
        ...
        const texture = new TextureLoader().load('textures/triangle_curve.png');
        const config = {
            duration: 5,
            looping: true,
        ...
        config.renderMode = RenderMode.StretchedBillBoard;
        config.rendererEmitterSettings = {
            speedFactor: 0,
            lengthFactor: 2,
        };
